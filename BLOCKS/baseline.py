...
from BLOCKS.Block import Attention
...
class Baseline(nn.Module): 
    ...
    def __init__(self, stages_repeats, stages_out_channels, num_classes=7):
        ...
        self.local = LocalFeatureExtractor(32, 128, 1)
        self.block = Attention(28,28,128)            
...
def baseline():
    model = Baseline([4, 8, 4], [32, 128, 256, 512, 1024])
    return model
